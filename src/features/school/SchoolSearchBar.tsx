...
export default function SchoolSearchBar() {
  ...
  return (
    <div className="flex h-[84px] items-center gap-2.5 rounded-2xl bg-white p-3 pl-5 shadow-lg shadow-pink-900/5">
      <PinIcon />
      <input
        value={query}
      ...
      <button
        ...
        onClick={submit}
        aria-label="검색"
        className="flex h-full w-[60px] shrink-0 items-center justify-center rounded-xl bg-pink-500 text-white active:bg-pink-600"
      >
...
function PinIcon() {
  return (
    <svg width="19" height="19" viewBox="0 0 16 16" fill="#F472B6" aria-hidden="true" className="shrink-0">
